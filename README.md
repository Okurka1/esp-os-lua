...
[![Version: v0.0.4.1](https://img.shields.io/badge/Version-v0.0.4.1-success)](CHANGELOG.md)
...
### Bootloader (v0.0.2)
- 🔧 **Advanced bootloader** with interactive menu
- 🔄 **Dual-boot system** (Main OS, Recovery, Alternative OS)
- 🛡️ **Auto-recovery** mode on boot failure
- ⚙️ **Persistent configuration** stored on SD card
- 🔑 **BOOT button detection** for manual intervention
- 📊 **Boot diagnostics** (boot count, timestamps)
- 💾 **Persistent reboot flags** via NVS (recovery/bootloader modes)
...
- 💻 **Terminal console** with extended commands
...
- [CHANGELOG.md](CHANGELOG.md) — release history (v0.0.1 → v0.0.4)
- [CONTRIBUTING.md](CONTRIBUTING.md) — contribution workflow
- [docs/LUA_API.md](docs/LUA_API.md) — complete Lua API reference
- [docs/BOOTLOADER.md](docs/BOOTLOADER.md) — bootloader documentation and features
- `sd_card_files/ESP-OS/` — runtime Lua system files
- `sd_card_files/ESP-OS-Recovery/` — recovery mode files
...
- ✅ **v0.0.4**: CMD ls implementation, memory optimizations, Lua API docs, Advanced bootloader, Recovery mode
- ✅ **v0.0.4.1**: Bug fixes, RAM optimization (-700B), ANSI toggle support
- 🔜 **v0.0.5**: OTA updates, web interface, partial PSRAM support, Secure Boot
- 🔜 **v0.0.6**: Expanded TFT workflow and richer UI tools
